...
TodaysDealModel todaysDealModel;
...
TextView deal_add,deal_email,deal_ph,deal_web;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            todaysDealModel= (TodaysDealModel) getIntent().getSerializableExtra("model");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        pronamesub=(TextView)findViewById(R.id.pro_name_sub);
        pro_offer=(TextView)findViewById(R.id.pro_offer);
        pro_offer_sub=(TextView)findViewById(R.id.pro_offer_sub);
        pro_price=(TextView)findViewById(R.id.pro_price);
        pro_price_sub=(TextView)findViewById(R.id.pro_price_sub);
        deal_add=(TextView)findViewById(R.id.deal_web);
        deal_email=(TextView)findViewById(R.id.deal_email);
        deal_ph=(TextView)findViewById(R.id.deal_ph);
        deal_web=(TextView)findViewById(R.id.deal_web);
